...
public class OBKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OBKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OBKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OBKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OBKDateTimeConverter dateTimeConverter = new OBKStandardDateTimeConverter();

    public OBKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OBKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OBKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OBKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OBKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OBKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
