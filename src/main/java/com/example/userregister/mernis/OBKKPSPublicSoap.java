...
public class OBKKPSPublicSoap
{
    ...
    public OBKKPSPublicSoap(){}

    public OBKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OBKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OBKExtendedSoapSerializationEnvelope envelope= new OBKExtendedSoapSerializationEnvelope(OBKExtendedSoapSerializationEnvelope.VER11);
